        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-2xl ring-1 ring-black/5 p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={handleAddLink} className="px-4 py-2 bg-signal text-white text-[13px] font-medium rounded-full hover:opacity-90 transition-opacity whitespace-nowrap flex items-center gap-2">
