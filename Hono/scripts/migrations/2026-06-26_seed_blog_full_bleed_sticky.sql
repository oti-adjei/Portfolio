-- Seed: published blog post "The full-bleed hero that broke my sticky header"
-- Idempotent: uses INSERT OR REPLACE keyed on id.
-- Note: content is stored as plain markdown (no frontmatter).

INSERT OR REPLACE INTO blog_posts (
  id, title, slug, date, excerpt, content, external_url, tags, published, created_at, updated_at
) VALUES (
  'post-sticky-header',
  'The full-bleed hero that broke my sticky header',
  'full-bleed-hero-broke-my-sticky-header',
  '2026-06-26',
...
Now I have one.',
  NULL,
  '["CSS","Layout","Sticky","Overflow","Debugging"]',
  1,
  CURRENT_TIMESTAMP,
  CURRENT_TIMESTAMP
);
